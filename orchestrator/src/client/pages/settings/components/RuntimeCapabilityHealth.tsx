...
export const RuntimeCapabilityHealth: React.FC<
  RuntimeCapabilityHealthProps
> = ({ health, isLoading, onRefresh, layoutMode }) => (
  ...
  >
    <div className="space-y-3">
      ...
      <p className="text-sm text-muted-foreground">
        Read-only checks for this workspace. Credentials and configuration
      ...
      {!health && !isLoading ? (
        <p className="text-sm text-muted-foreground">
          Runtime health is not available yet.
        </p>
      ) : null}
