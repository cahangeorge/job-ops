...
export async function getJobListItems(
  ...
  const selection = {
    ...
    evaluationRoleSummary: jobs.evaluationRoleSummary,
    evaluationCvMatchScore: jobs.evaluationCvMatchScore,
    evaluationCvMatchReason: jobs.evaluationCvMatchReason,
    evaluationLevelStrategy: jobs.evaluationLevelStrategy,
    evaluationCompResearch: jobs.evaluationCompResearch,
    evaluationPersonalization: jobs.evaluationPersonalization,
    evaluationInterviewPrep: jobs.evaluationInterviewPrep,
    evaluationLegitimacyScore: jobs.evaluationLegitimacyScore,
    evaluationLegitimacyReason: jobs.evaluationLegitimacyReason,
    evaluationOverallGrade: jobs.evaluationOverallGrade,
    archetype: jobs.archetype,
    isGhostJob: jobs.isGhostJob,
...
function mapRowToJob(row: typeof jobs.$inferSelect): Job {
  return {
    ...
    evaluationLevelStrategy: row.evaluationLevelStrategy ?? null,
    evaluationCompResearch: row.evaluationCompResearch ?? null,
    evaluationPersonalization: row.evaluationPersonalization ?? null,
    evaluationInterviewPrep: row.evaluationInterviewPrep ?? null,
    evaluationLegitimacyScore: row.evaluationLegitimacyScore ?? null,
    evaluationLegitimacyReason: row.evaluationLegitimacyReason ?? null,
    evaluationOverallGrade: row.evaluationOverallGrade ?? null,
    archetype: row.archetype ?? null,
    isGhostJob: row.isGhostJob ?? null,
