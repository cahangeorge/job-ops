...
export const createJob = (overrides: Partial<Job> = {}): Job => ({
  ...
  postingLivenessCheckedAt: null,
  postingLivenessReason: null,
  appliedDuplicateMatch: null,
  evaluationRoleSummary: null,
  evaluationCvMatchScore: null,
  evaluationCvMatchReason: null,
  evaluationLevelStrategy: null,
  evaluationCompResearch: null,
  evaluationPersonalization: null,
  evaluationInterviewPrep: null,
  evaluationLegitimacyScore: null,
  evaluationLegitimacyReason: null,
  evaluationOverallGrade: null,
  archetype: null,
  isGhostJob: null,
  jobType: null,
  salarySource: null,
